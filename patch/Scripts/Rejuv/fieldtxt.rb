...
:ELECTERRAIN => {
	...
	:mimicry => :ELECTRIC,
	:damageMods => {
		1.5 => [:EXPLOSION, :SELFDESTRUCT, :HURRICANE, :SURF, :SMACKDOWN, :MUDDYWATER, :THOUSANDARROWS, :WINDBOLTSTORM, :PSYBLADE],
		2.0 => [:MAGNETBOMB],
	},
	:accuracyMods => {
	},
	:moveMessages => {
		...
		"The attack became hyper-charged!" => [:HURRICANE, :SURF, :SMACKDOWN, :MUDDYWATER, :THOUSANDARROWS, :WINDBOLTSTORM, :PSYBLADE],
	...
	:overlay => {
		:damageMods => {
			1.5 => [:EXPLOSION, :SELFDESTRUCT, :HURRICANE, :SURF, :SMACKDOWN, :MUDDYWATER, :THOUSANDARROWS, :PSYBLADE],
			2.0 => [:MAGNETBOMB],
		},
		:typeMods => {
		...
		:moveMessages => {
			"The explosion became hyper-charged!" => [:EXPLOSION, :SELFDESTRUCT],
			"The attack became hyper-charged!" => [:HURRICANE, :SURF, :SMACKDOWN, :MUDDYWATER, :THOUSANDARROWS, :PSYBLADE],
			"The attack powered up!" => [:MAGNETBOMB],
		},
		:typeBoosts => {
			1.5 => [:ELECTRIC],
...
:GRASSY => {
	...
	:dontChangeBackup => [],
	:changeMessage => {
		 "The grassy terrain was corroded!" => [:SLUDGEWAVE, :ACIDDOWNPOUR, :CORRODE],
...
:MISTY => {
	...
	:damageMods => {
		...
		0.5 => [:DARKPULSE, :SHADOWBALL, :NIGHTDAZE, :LUNARCANNON],
	...
	:moveMessages => {
		...
		"The mist softened the attack..." => [:DARKPULSE, :SHADOWBALL, :NIGHTDAZE, :LUNARCANNON],
	...
	:changeMessage => {
		 ...
		 "The mist was corroded!" => [:CLEARSMOG, :SMOG, :POISONGAS, :ACIDDOWNPOUR, :CORRODE],
	},
...
:DARKCRYSTALCAVERN => {
	...
	:mimicry => :DARK,
	:damageMods => {
		1.5 => [:DARKPULSE, :LUNARCANNON, :NIGHTDAZE, :NIGHTSLASH, :SHADOWBALL, :SHADOWPUNCH, :SHADOWCLAW, :SHADOWSNEAK, :SHADOWFORCE, :SHADOWBONE, :AURORABEAM, :SIGNALBEAM, :FLASHCANNON, :LUSTERPURGE, :DAZZLINGGLEAM, :MIRRORSHOT, :MIRRORBEAM, :TECHNOBLAST, :DOOMDUMMY, :POWERGEM, :MOONGEISTBEAM, :PHOTONGEYSER, :DIAMONDSTORM, :MENACINGMOONRAZEMAELSTROM, :BLACKHOLEECLIPSE, :CRYSTALRUSH],
		2.0 => [:PRISMATICLASER],
	...
	:moveMessages => {
		"The darkness began to gather...!" => [:DARKPULSE, :NIGHTDAZE, :NIGHTSLASH, :LUNARCANNON],
...
:RAINBOW => {
	...
	:damageMods => {
		...
		0.5 => [:DARKPULSE, :LUNARCANNON, :SHADOWBALL, :NIGHTDAZE, :NEVERENDINGNIGHTMARE],
		0 => [:NIGHTMARE]
	},
	:accuracyMods => {},
	:moveMessages => {
		...
		"The rainbow softened the attack..." => [:DARKPULSE, :LUNARCANNON, :SHADOWBALL, :NIGHTDAZE, :NEVERENDINGNIGHTMARE],
...
:CORROSIVE => {
	...
	:damageMods => {
		...
		2.0 => [:ACID, :ACIDSPRAY, :GRASSKNOT, :SNAPTRAP, :CORRODE],
	},
	:accuracyMods => {
		100 => [:POISONPOWDER, :SLEEPPOWDER, :STUNSPORE, :TOXIC],
	},
	:moveMessages => {
		"The corrosion strengthened the attack!" => [:SMACKDOWN, :MUDSLAP, :MUDSHOT, :MUDBOMB, :MUDDYWATER, :WHIRLPOOL, :THOUSANDARROWS, :APPLEACID, :ACID, :ACIDSPRAY, :GRASSKNOT, :SNAPTRAP, :CORRODE],
	},
	:typeMods => {
...
:CORROSIVEMIST => {
	...
	:mimicry => :POISON,
	:damageMods => {
		1.5 => [:BUBBLEBEAM, :ACIDSPRAY, :BUBBLE, :SMOG, :CLEARSMOG, :SPARKLINGARIA, :CORRODE],
	},
	:accuracyMods => {
		100 => [:TOXIC],
	},
	:moveMessages => {
		"The poison strengthened the attack!" => [:BUBBLEBEAM, :ACIDSPRAY, :BUBBLE, :SMOG, :CLEARSMOG, :SPARKLINGARIA, :APPLEACID, :CORRODE],
	},
	:typeMods => {
...
:ICY => {
	...
	:statusMods => [:HAIL, :AURORAVEIL, :HYPOTHERMIA],
	:changeEffects => {},
	:seed => {
		:seedtype => :ELEMENTALSEED,
		:effect => nil,
...
:SHORTCIRCUIT => {
	...
	:damageMods => {
		...
		1.3 => [:DARKPULSE, :LUNARCANNON, :NIGHTDAZE, :NIGHTSLASH, :SHADOWBALL, :SHADOWPUNCH, :SHADOWCLAW, :SHADOWSNEAK, :SHADOWFORCE, :SHADOWBONE, :PHANTOMFORCE],
		0.5 => [:LIGHTTHATBURNSTHESKY],
	},
	:accuracyMods => {
		80 => [:ZAPCANNON],
	...
	:moveMessages => {
		...
		"The darkness strengthened the attack!" => [:DARKPULSE, :LUNARCANNON, :NIGHTDAZE, :NIGHTSLASH, :SHADOWBALL, :SHADOWPUNCH, :SHADOWCLAW, :SHADOWSNEAK, :SHADOWFORCE, :SHADOWBONE, :PHANTOMFORCE],
		"{1} couldn't consume much light..." => [:LIGHTTHATBURNSTHESKY],
	},
	:typeMods => {
...
:CRYSTALCAVERN => {
	...
	:damageMods => {
		...
		1.5 => [:POWERGEM, :DIAMONDSTORM, :ANCIENTPOWER, :JUDGMENT, :ROCKSMASH, :ROCKTOMB, :STRENGTH, :ROCKCLIMB, :MULTIATTACK, :PRISMATICLASER, :LUSTERPURGE, :CRYSTALRUSH],
	},
	:accuracyMods => {},
	:moveMessages => {
	...
	:fieldChange => {
		:CAVE => [:EARTHQUAKE, :BULLDOZE, :MAGNITUDE, :FISSURE, :TECTONICRAGE],
		:DARKCRYSTALCAVERN => [:DARKPULSE, :LUNARCANNON, :DARKVOID, :NIGHTDAZE, :LIGHTTHATBURNSTHESKY, :DARKMATTER],
	},
	:dontChangeBackup => [:EARTHQUAKE, :BULLDOZE, :MAGNITUDE, :FISSURE, :TECTONICRAGE, :DARKPULSE, :LUNARCANNON, :DARKVOID, :NIGHTDAZE],
	:changeMessage => {
		 "The crystals were broken up!" => [:EARTHQUAKE, :BULLDOZE, :MAGNITUDE, :FISSURE, :TECTONICRAGE],
		 "The crystals' light was warped by the darkness!" => [:DARKPULSE, :LUNARCANNON, :DARKVOID, :NIGHTDAZE, :DARKMATTER],
...
:FAIRYTALE => {
	...
	:mimicry => :FAIRY,
	:damageMods => {
		1.5 => [:NIGHTSLASH, :LEAFBLADE, :PSYCHOCUT, :SMARTSTRIKE, :AIRSLASH, :SOLARBLADE, :MAGICALLEAF, :MYSTICALFIRE, :ANCIENTPOWER, :RELICSONG, :SPARKLINGARIA, :MOONGEISTBEAM, :FLEURCANNON, :RAZORSHELL, :BEHEMOTHBLADE, :BEHEMOTHBASH, :OCEANICOPERETTA, :MENACINGMOONRAZEMAELSTROM,:CEASELESSEDGE,:STONEAXE,:AQUACUTTER,:ANCIENTROAR],
	...
	:moveMessages => {
		...
		"Come not between the dragon, and its wrath!" => [:ANCIENTROAR],
	},
	:typeMods => {},
	:typeAddOns => {
		:DRAGON => [:FIRE],
...
:DRAGONSDEN => {
	...
	:mimicry => :DRAGON,
	:damageMods => {
		1.5 => [:MEGAKICK, :MAGMASTORM, :LAVAPLUME, :STOMPINGTANTRUM, :EARTHPOWER, :DIAMONDSTORM, :MATRIXSHOT, :SHELLTRAP, :POWERGEM, :MAGMADRIFT, :ROCKCLIMB, :STRENGTH, :ANCIENTROAR],             
	...
	:moveMessages => {
		...
		"Roar of the Dragon!!!" => [:ANCIENTROAR],
		...
		"The " + HAILSNOWLOWMOD + " is melting in the heat..." => [:HAIL],
	},
	:typeMods => {
...
:FLOWERGARDEN2 => {
	...
	:fieldChange => {
		...
		:FLOWERGARDEN1 => [:CUT,:XSCISSOR,:ACIDDOWNPOUR,:SHADOWPRAYER],
	},
	:dontChangeBackup => [],
	:changeMessage => {
		"The garden was cut down a bit!" => [:CUT,:XSCISSOR],
		"The garden regressed in growth!" => [:SHADOWPRAYER],
		"The garden grew a little!" => [:GROWTH,:FLOWERSHIELD,:RAINDANCE,:SUNNYDAY,:ROTOTILLER,:INGRAIN,:GRASSYTERRAIN,:WATERSPORT,:BLOOMDOOM],
...
:FLOWERGARDEN3 => {
	...
	:fieldChange => {
		...
		:FLOWERGARDEN2 => [:CUT,:XSCISSOR,:SHADOWPRAYER],
...
:FLOWERGARDEN4 => {
	...
	:fieldChange => {
		...
		:FLOWERGARDEN3 => [:CUT,:XSCISSOR,:SHADOWPRAYER],
...
:FLOWERGARDEN5 => {
	...
	:fieldChange => {
		:FLOWERGARDEN4 => [:CUT,:XSCISSOR,:SHADOWPRAYER],
		:FLOWERGARDEN1 => [:ACIDDOWNPOUR],
...
:STARLIGHT => {
	...
	:mimicry => :DARK,
	:damageMods => {
		1.5 => [:AURORABEAM, :SIGNALBEAM, :FLASHCANNON, :LUSTERPURGE, :DAZZLINGGLEAM, :MIRRORSHOT, :MIRRORBEAM, :TECHNOBLAST, :SOLARBEAM, :PHOTONGEYSER, :MOONBLAST, :PRISMATICLASER, :NIGHTSLASH, :NIGHTDAZE, :LUNARCANNON],
	...
	:moveMessages => {
		...
		"Lunar energy surged through the attack!" => [:MOONBLAST, :NIGHTSLASH, :NIGHTDAZE, :LUNARCANNON],
...
:DIMENSIONAL => {
	...
	:damageMods => {
		...
		1.2 => [:DARKPULSE, :LUNARCANNON, :NIGHTDAZE],
		0 => [:HAIL, :SUNNYDAY, :SANDSTORM, :RAINDANCE, :TEATIME, :LUCKYCHANT],
	},
	:accuracyMods => {
		0 => [:DARKVOID, :DARKPULSE, :LUNARCANNON, :NIGHTDAZE],
	},
	:moveMessages => {
		"The attack has been corrupted." => [:HYPERSPACEFURY, :HYPERSPACEHOLE, :SPACIALREND, :ROAROFTIME, :ETERNABEAM, :DYNAMAXCANNON, :SHADOWFORCE, :DARKPULSE, :LUNARCANNON, :NIGHTDAZE],
		...
		"The dark dimension swallowed the " + HAILSNOWLOWMOD + "." => [:HAIL],
...
:FROZENDIMENSION => {
	...
	:damageMods => {
		...
		1.2 => [:SURF, :MUDDYWATER, :WATERPULSE, :HYDROPUMP, :NIGHTSLASH, :DARKPULSE, :LUNARCANNON, :HYPERSPACEFURY, :HYPERSPACEHOLE],
	...
	:moveMessages => {
		...
		"The ice warped the attack." => [:SURF, :MUDDYWATER, :WATERPULSE, :HYDROPUMP, :NIGHTSLASH, :DARKPULSE, :LUNARCANNON, :HYPERSPACEFURY, :HYPERSPACEHOLE],
	...
	:typeMods => {
		:ICE => [:SURF, :MUDDYWATER, :WATERPULSE, :HYDROPUMP, :NIGHTSLASH, :DARKPULSE, :LUNARCANNON],
	},
	:typeAddOns => {
	},
	:moveEffects => {},
	...
	:statusMods => [:PARTINGSHOT, :AURORAVEIL, :DARKVOID, :HYPOTHERMIA],
	:changeEffects => {},
	:seed => {
		:seedtype => :ELEMENTALSEED,
		:effect => :Torment,
...
:BEWITCHED => {
	...
	:moveMessages => {
		"Magic aura amplified the attack!" => [:HEX, :MYSTICALFIRE, :SPIRITBREAK, :SPIRITAWAY, :ICEBEAM, :HYPERBEAM, :SIGNALBEAM, :AURORABEAM, :CHARGEBEAM, :PSYBEAM, :FLASHCANNON, :MIRRORBEAM, :MAGICALLEAF, :BUBBLEBEAM],
		"The forest is cursed with nightfall!" => [:DARKPULSE, :NIGHTDAZE, :MOONBLAST, :LUNARCANNON],
	},
	:typeMods => {
	},
	:typeAddOns => {
...
:COLOSSEUM => {
	...
	:damageMods => {
		...
		1.5 => [:SACREDSWORD, :SECRETSWORD, :SUBMISSION, :METEORASSAULT, :SMARTSTRIKE, :SMACKDOWN, :BRUTALSWING, :ELECTROWEB, :VINEWHIP, :PSYCHOCUT, :NIGHTSLASH, :BONEMERANG, :FIRSTIMPRESSION, :BONERUSH, :BONECLUB, :LEAFBLADE, :PAYBACK, :PUNISHMENT, :METEORMASH, :BULLETPUNCH, :CLANGINGSCALES, :STEAMROLLER, :ACHILLESHEEL],
...
:INFERNAL => {
	...
	:typeMods => {
		:DARK => [:SPIRITBREAK, :SPIRITAWAY, :AURASPHERE, :FRUSTRATION],
	},
	:typeAddOns => {
	...
	:typeCondition => {
		:FAIRY => "@move != [:SPIRITBREAK, :SPIRITAWAY]",
	},
	:typeEffects => {},
	:changeCondition => {
	},
...
:DEEPEARTH => {
	...
	:damageMods => {
		...
		1.5 => [:HEAVYSLAM,	:HEATCRASH, :BODYSLAM, :STOMP, :DRAGONRUSH, :STEAMROLLER, :GRAVAPPLE, :ANCIENTPOWER, :FLING, :GRASSKNOT, :LOWKICK, :SPACIALREND, :STORMTHROW, :CIRCLETHROW, :VITALTHROW, :BODYPRESS, :SUBMISSION, :ICEHAMMER, :HAMMERARM, :CRABHAMMER, :ICICLECRASH, :THOUSANDARROWS, :THOUSANDWAVES, :ANCIENTROAR],
	},
	:accuracyMods => {
	},
	:moveMessages => {
		...
		"The power of ages gone by..." => [:ANCIENTPOWER, :ANCIENTROAR],
