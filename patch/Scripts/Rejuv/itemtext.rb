...
:ICYROCK => {
	:ID => 87,
	:name => "Icy Rock",
	:desc => "A Pokémon held item that extends the duration of the move " + HAILSNOWNAMEMOD + " used by the holder.",
	:price => 200,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:TM07 => {
	:ID => 294,
	:name => "TM07",
	:desc => "Summons a " + HAILSNOWLOWMOD + "storm that lasts for five turns. The " + HAILSNOWLOWMOD + "storm damages all types except Ice.",
	:price => 30000,
	:tm => :HAIL,
	:noUseInBattle => true,
},
...
:TM111 => {
	:ID => 717,
	:name => "TM111",
	:desc => "This move reduces damage from physical and special moves for five turns. This can be used only in a " + HAILSNOWLOWMOD + "storm.",
	:price => 100000,
	:tm => :AURORAVEIL,
	:noUseInBattle => true,
},
...
:EMPCREST => {
	:ID => 882,
	:name => "Empoleon Crest",
	:desc => "Empoleon's Ice-type moves are boosted by 50%, and Speed is doubled in " + HAILSNOWLOWMOD + " and on Ice Fields.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:BOOSTERENERGY => {
	:ID => 1109,
	:name => "Booster Energy",
	:desc => "An item to be held by Pokémon with certain Abilities. It boosts the strength of the Pokémon.",
	:price => 0,
	:noUseInBattle => true,
	:noUse => true,
	:consumehold => true,
...
:ABILITYSHIELD => {
	:ID => 1110,
	:name => "Ability Shield",
	:desc => "An item to be held by a Pokémon. This  shield protects the holder from having its Ability changed by others.",
	:price => 2000,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:CLEARAMULET => {
	:ID => 1111,
	:name => "Clear Amulet",
	:desc => "An item to be held by a Pokémon. It protects the holder from having its stats lowered.",
	:price => 3000,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:MIRRORHERB => {
	:ID => 1112,
	:name => "Mirror Herb",
	:desc => "An item to be held by a Pokémon. This herb will allow the holder to mirror an opponent's stat increases once.",
	:price => 100,
	:noUseInBattle => true,
	:consumehold => true,
},
...
:PUNCHINGGLOVE => {
	:ID => 1113,
	:name => "Punching Glove",
	:desc => "An item to be held by a Pokémon. It boosts the holder's punching moves and prevents direct contact.",
	:price => 2000,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:COVERTCLOAK => {
	:ID => 1114,
	:name => "Covert Cloak",
	:desc => "An item to be held by a Pokémon. It conceals the holder, protecting it from move's additional effects.",
	:price => 2000,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:LOADEDDICE => {
	:ID => 1115,
	:name => "Loaded Dice",
	:desc => "An item to be held by a Pokémon. It ensures the holder's multistrike moves hit more times.",
	:price => 100,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:GIMMIGHOULCOIN => {
	...
	:desc => "An item that accidentally dropped by a Pokémon. It seems that Gimmighoul treasure and hoard these.",
	:price => 0,
},
...
:TINYBAMBOOSHOOT => {
	...
	:desc => "A small and rare bamboo shoot. It's quite popular with a certain class of gourmands.",
	:price => 1500,
},
...
:BIGBAMBOOSHOOT => {
	...
	:desc => "A large and rare bamboo shoot. It's extremely popular with a certain class of gourmands.",
	:price => 6000,
},
...
:HEALTHMOCHI => {
	:ID => 1119,
	:name => "Health Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's HP stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:MUSCLEMOCHI => {
	:ID => 1120,
	:name => "Muscle Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's Attack stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:RESISTMOCHI => {
	:ID => 1121,
	:name => "Resist Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's Defense stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:GENIUSMOCHI => {
	:ID => 1122,
	:name => "Genius Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's Sp. Atk stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:CLEVERMOCHI => {
	:ID => 1123,
	:name => "Clever Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's Sp. Def stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:SWIFTMOCHI => {
	:ID => 1124,
	:name => "Swift Mochi",
	:desc => "A mochi cake with Berries kneaded into its dough. It increases base points for a Pokémon's Speed stat.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:FRESHSTARTMOCHI => {
	...
	:desc => "A mochi cake with Berries kneaded into its dough. It causes a Pokémon to lose all its base points.",
	:price => 250,
	:medicine => true,
	:noUseInBattle => true,
	:evup => true,
...
:FAIRYFEATHER => {
	:ID => 1126,
	:name => "Fairy Feather",
	:desc => "An item to be held by a Pokémon. It boosts the power of the holder's Fairy-type moves.",
	:price => 100,
	:noUseInBattle => true,
	:noUse => true,
	:typeboost => :FAIRY,
...
:TEALMASK => {
	:ID => 1133,
	:name => "Teal Mask",
	:desc => "A teal mask patterned after the face of an ogre. Dropped by Ogerpon after visiting the Festival of Masks.",
	:price => 0,
	:noUseInBattle => true,
	:noUse => true,
	:keyitem => true,
...
:TM159 => {
	:ID => 1136,
	:name => "TM159",
	:desc => "The user attacks suddenly as if leaping out from tall grass. The user's nimble footwork boosts its Speed stat.",
	:price => 25000,
	:tm => :TRAILBLAZE,
	:noUseInBattle => true,
},
...
:TM160 => {
	:ID => 1137,
	:name => "TM160",
	:desc => "The user covers its feet in thin ice and twirls around, slamming into the target. This move's spinning motion also destroys the terrain.",
	:price => 25000,
	:tm => :ICESPINNER,
	:noUseInBattle => true,
},
...
:TM161 => {
	:ID => 1138,
	:name => "TM161",
	:desc => "The user attacks the target by showering it with water that's so cold it saps the target's power. This also lowers the target's Attack stat.",
	:price => 25000,
	:tm => :CHILLINGWATER,
	:noUseInBattle => true,
},
...
:TM162 => {
	:ID => 1139,
	:name => "TM162",
	:desc => "The target is crushed with an arm, a claw, or the like to inflict damage. The more HP the target has left, the greater the move's power.",
	:price => 25000,
	:tm => :HARDPRESS,
	:noUseInBattle => true,
},
...
:TM163 => {
	:ID => 1140,
	:name => "TM163",
	:desc => "The user raises its allies' morale with a draconic cry so that their future attacks have a heightened chance of landing critical hits. This rouses Dragon types more.",
	:price => 25000,
	:tm => :DRAGONCHEER,
	:noUseInBattle => true,
},
...
:TM165 => {
	:ID => 1142,
	:name => "TM165",
	:desc => "Spurred by desperation, the user attacks the target. This move's power is doubled if the user's previous move failed.",
	:price => 25000,
	:tm => :TEMPERFLARE,
	:noUseInBattle => true,
},
...
:TM166 => {
	:ID => 1143,
	:name => "TM166",
	:desc => "The user electrifies its body and drops onto the target to inflict damage. If this move misses, the user takes damage instead.",
	:price => 25000,
	:tm => :SUPERCELLSLAM,
	:noUseInBattle => true,
},
...
:TM167 => {
	:ID => 1144,
	:name => "TM167",
	:desc => "The user attacks the target with unpleasant sound waves. For two turns, the target is prevented from recovering HP through moves, Abilities, or held items.",
	:price => 25000,
	:tm => :PSYCHICNOISE,
	:noUseInBattle => true,
},
...
:TM168 => {
	:ID => 1145,
	:name => "TM168",
	:desc => "The user reacts to the target's movement and strikes with the heel of its palm, making the target flinch. This move fails if the target is not readying a priority move.",
	:price => 25000,
	:tm => :UPPERHAND,
	:noUseInBattle => true,
},
...
:DELTAVENUSAURITE => {
	:ID => 1201,
	:name => "D. Venusaurite",
	:desc => "One variety of Mega Stone. Have Delta Venusaur hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTACHARIZARDITEY => {
	:ID => 1202,
	:name => "D. Charizardite Y",
	:desc => "One variety of Mega Stone. Have Delta Charizard hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTABLASTOISINITE => {
	:ID => 1203,
	:name => "D. Blastoisinite",
	:desc => "One variety of Mega Stone. Have Delta Blastoise hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTABISHARPITE => {
	:ID => 1204,
	:name => "D. Bisharpite",
	:desc => "One variety of Mega Stone. Have Delta Bisharp hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAGARDEVOIRITE => {
	:ID => 1205,
	:name => "D. Gardevoirite",
	:desc => "One variety of Mega Stone. Have Delta Gardevoir hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAGALLADITE => {
	:ID => 1206,
	:name => "D. Galladite",
	:desc => "One variety of Mega Stone. Have Delta Gallde hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTASUNFLORITE => {
	:ID => 1207,
	:name => "D. Sunflorite",
	:desc => "One variety of Mega Stone. Have Delta Sunflora hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTASCIZORITE => {
	:ID => 1208,
	:name => "D. Scizorite",
	:desc => "One variety of Mega Stone. Have Delta Scizor hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAGLALITITE => {
	:ID => 1209,
	:name => "D. Glalitite",
	:desc => "One variety of Mega Stone. Have Delta Glalie hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAFROSLASSITE => {
	:ID => 1210,
	:name => "D. Froslassite",
	:desc => "One variety of Mega Stone. Have Delta Froslass hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTATYPHLOSIONITE => {
	:ID => 1211,
	:name => "D. Typhlosionite",
	:desc => "One variety of Mega Stone. Have Delta Typhlosion hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAPIDGEOTITE => {
	:ID => 1212,
	:name => "D. Pidgeotite",
	:desc => "One variety of Mega Stone. Have Delta Pidgeot hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAMILOTITE => {
	:ID => 1213,
	:name => "D. Milotite",
	:desc => "One variety of Mega Stone. Have Delta Milotic hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAMETAGROSSITE1 => {
	:ID => 1214,
	:name => "D. Metagrossite (S)",
	:desc => "One variety of Mega Stone. Have Delta Metagross (Spider) hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAMETAGROSSITE2 => {
	:ID => 1215,
	:name => "D. Metagrossite (R)",
	:desc => "One variety of Mega Stone. Delta Metagross (Ruin) hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CRYSTALFRAGMENT => {
	...
	:desc => "A special gemstone created from powerful crystals. It allows certain Pokemon to undergo Crystallization.",
	:price => 10000,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DVOLCARONAARMOR => {
	:ID => 1219,
	:name => "D. Volcarona Armor",
	:desc => "A special set of armor that is designed for Delta Volcarona.",
	:price => 10000,
	:armor => true,
	:noUseInBattle => true,
	:noUse => true,
...
:NOCTURNEINCENSE => {
	...
	:desc => "An item to be held by a Pokémon. It allows the holder to flee battles under the cover of darkness.",
	:price => 9600,
	:noUseInBattle => true,
	:noUse => true,
	:incense => true,
...
:SHADOWROCK => {
	:ID => 1221,
	:name => "Shadow Rock",
	:desc => "A Pokémon held item that extends the duration of the move New Moon used by the holder.",
	:price => 1221,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:MILOTITE => {
	:ID => 1222,
	:name => "Milotite",
	:desc => "One variety of Mega Stone. Have Milotic hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:AEVIANLAPRASITE => {
	:ID => 1223,
	:name => "A. Laprasite",
	:desc => "One variety of Mega Stone. Have Aevian Lapras hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:AEVIANAMPHAROSITE => {
	:ID => 1224,
	:name => "A. Ampharosite",
	:desc => "One variety of Mega Stone. Have Aevian Ampharos hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:AEVIANGLALITITE => {
	:ID => 1225,
	:name => "A. Glalitite",
	:desc => "One variety of Mega Stone. Have Aevian Glalie hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:AEVIANTOXTRICITITE => {
	:ID => 1226,
	:name => "A. Toxtricitite",
	:desc => "One variety of Mega Stone. Have Aevian Toxtricity hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAAGGRONITE => {
	:ID => 1227,
	:name => "D. Aggronite",
	:desc => "One variety of Mega Stone. Have Delta Aggron hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:SPIRITCANDLE => {
	:ID => 1228,
	:name => "Spirit Candle",
	:desc => "A candle meant to be used for calling the spirits. Laughter can be heard as the flame burns brighter.",
	:price => 2000,
	:noUseInBattle => true,
	:noUse => true,
},
...
:POLIWRATHITE => {
	:ID => 1229,
	:name => "Poliwrathite",
	:desc => "One variety of Mega Stone. Have Poliwrath hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:MAROWITE => {
	:ID => 1230,
	:name => "Marowite",
	:desc => "One variety of Mega Stone. Have Marowak hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:TYPHLOSIONITE => {
	:ID => 1233,
	:name => "Typhlosionite",
	:desc => "One variety of Mega Stone. Have Typhlosion hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:SUDOWOODITE => {
	:ID => 1235,
	:name => "Sudowoodite",
	:desc => "One variety of Mega Stone. Have Sudowoodo hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:POLITOEDITE => {
	:ID => 1236,
	:name => "Politoedite",
	:desc => "One variety of Mega Stone. Have Politoed hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:SUNFLORITE => {
	:ID => 1237,
	:name => "Sunflorite",
	:desc => "One variety of Mega Stone. Have Sunflora hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:GIRAFARIGITE => {
	:ID => 1238,
	:name => "Girafarigite",
	:desc => "One variety of Mega Stone. Have Girafarig hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTAGIRAFARIGITE => {
	:ID => 1239,
	:name => "D. Girafarigite",
	:desc => "One variety of Mega Stone. Have Delta Girafarig hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DONPHANITE => {
	:ID => 1240,
	:name => "Donphanite",
	:desc => "One variety of Mega Stone. Have Donphan hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:MILTANKITE => {
	:ID => 1241,
	:name => "Miltankite",
	:desc => "One variety of Mega Stone. Have Miltank hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:SHIFTRITE => {
	:ID => 1242,
	:name => "Shiftrite",
	:desc => "One variety of Mega Stone. Have Shiftry hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:FLYGONITE => {
	:ID => 1243,
	:name => "Flygonite",
	:desc => "One variety of Mega Stone. Have Flygon hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CACTURNITE => {
	:ID => 1244,
	:name => "Cacturnite",
	:desc => "One variety of Mega Stone. Have Cacturne hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CRAWDITE => {
	:ID => 1245,
	:name => "Crawdite",
	:desc => "One variety of Mega Stone. Have Crawdaunt hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:JIRACHITE => {
	:ID => 1246,
	:name => "Jirachite",
	:desc => "One variety of Mega Stone. Have Jirachi hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELTALOPUNNITE => {
	:ID => 1247,
	:name => "D. Lopunnite",
	:desc => "One variety of Mega Stone. Have Delta Lopunny hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CHATOTITE => {
	:ID => 1248,
	:name => "Chatotite",
	:desc => "One variety of Mega Stone. Have Chatot hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:SPIRITOMBITE => {
	:ID => 1249,
	:name => "Spiritombite",
	:desc => "One variety of Mega Stone. Have Spiritomb hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:ZEBSTRIKITE => {
	:ID => 1251,
	:name => "Zebstrikite",
	:desc => "One variety of Mega Stone. Have Zebstrika hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:ZORONITE => {
	:ID => 1252,
	:name => "Zoronite",
	:desc => "One variety of Mega Stone. Have Zoroark hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:GOTHITITE => {
	:ID => 1253,
	:name => "Gothitite",
	:desc => "One variety of Mega Stone. Have Gothitelle hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:REUNICLITE => {
	:ID => 1254,
	:name => "Reuniclite",
	:desc => "One variety of Mega Stone. Have Reuniclus hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:HAXORITE => {
	:ID => 1255,
	:name => "Haxorite",
	:desc => "One variety of Mega Stone. Have Haxorus hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CRYOGONITE => {
	:ID => 1256,
	:name => "Cryogonite",
	:desc => "One variety of Mega Stone. Have Cryogonal hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:STUNFISKITE => {
	:ID => 1257,
	:name => "Stunfiskite",
	:desc => "One variety of Mega Stone. Have Stunfisk hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:BISHARPITE => {
	:ID => 1258,
	:name => "Bisharpite",
	:desc => "One variety of Mega Stone. Have Bisharp hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:HYDREIGONITE => {
	:ID => 1259,
	:name => "Hydreigonite",
	:desc => "One variety of Mega Stone. Have Hydreigon hold it, and this stone will enable it to Mega Evolve in battle.",
	:price => 999,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:CRYSTALPIECE => {
	:ID => 1261,
	:name => "Crystal Piece",
	:desc => "A mysterious crystal with an ancient power. It exudes a Primordial aura to legendary Pokemon around it.",
	:price => 10000,
	:crystal => true,
	:noUseInBattle => true,
	:noUse => true,
...
:IM01 => {
	:ID => 1262,
	:name => "IM01",
	:desc => "The user blots out the sun and moon, creating a blanket of shadows in the sky.",
	:price => 75000,
	:tm => :SHADOWPRAYER,
	:noUseInBattle => true,
},
...
:IM02 => {
	:ID => 1263,
	:name => "IM02",
	:desc => "A two-turn attack. The user gathers darkness, then blasts a bundled beam on the second turn.",
	:price => 75000,
	:tm => :LUNARCANNON,
	:noUseInBattle => true,
},
...
:IM03 => {
	:ID => 1264,
	:name => "IM03",
	:desc => "Deals Super Effective damage to users that use protecting moves.",
	:price => 75000,
	:tm => :ACHILLESHEEL,
	:noUseInBattle => true,
},
...
#:IM04 => {
	#:ID => 1265,
	#:name => "IM04",
	#:desc => "The user launches a corrosive acid at the opponent that is Super Effective against Steel-types.",
	#:price => 75000,
	#:tm => :CORRODE,
	#:noUseInBattle => true,
#},
...
:IM05 => {
	:ID => 1266,
	:name => "IM05",
	:desc => "The unknown forces of the world are unleashed. The user must recharge next turn.",
	:price => 75000,
	:tm => :DARKMATTER,
	:noUseInBattle => true,
},
...
:IM06 => {
	:ID => 1267,
	:name => "IM06",
	:desc => "A draconic fury in which the user always attacks first.",
	:price => 75000,
	:tm => :DRACOJET,
	:noUseInBattle => true,
},
...
:IM07 => {
	:ID => 1268,
	:name => "IM07",
	:desc => "Reptillian blood taints the foe, turning them into the Dragon-type.",
	:price => 75000,
	:tm => :DRAGONIFY,
	:noUseInBattle => true,
},
...
:SANCTUARYSTONEHALF1 => {
	:ID => 1274,
	:name => "Sanctuary Stone Piece",
	:desc => "A broken half of a mysterious stone. It radiates with blessed energy inside.",
	:price => 0,
	:keyitem => true,
	:noUseInBattle => true,
	:noUse => true,
...
:FROSTORB => {
	:ID => 1276,
	:name => "Frost Orb",
	:desc => "An item to be held by a Pokémon. It is a bizarre orb that inflicts frostbite on the holder in battle.",
	:price => 100,
	:noUseInBattle => true,
	:noUse => true,
	:battlehold => true,
...
:CASTLEKEY => {
	:ID => 1277,
	:name => "Castle Key",
	:desc => "A old, rusty iron key. It looks like it can be fitted into a castle door somewhere...",
	:price => 0,
	:keyitem => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DENOCCREST => {
	:ID => 1278,
	:name => "D. Noctowl Crest",
	:desc => "Reduces physical damage taken by 50%. If Noctowl moves after the target, its attack inflicts Frostbite.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DESCRACREST => {
	:ID => 1279,
	:name => "D. Scrafty Crest",
	:desc => "Recoil moves receive a x1.2 damage bonus and heal Scrafty instead of damaging it.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DEAVACREST => {
	:ID => 1280,
	:name => "D. Avalugg Crest",
	:desc => "All of Delta Avalugg's abilities are active. Its abilities cannot be changed, swapped, or removed.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DELUXCREST => {
	:ID => 1281,
	:name => "D. Luxray Crest",
	:desc => "Delta Luxray's Speed is equivalent with its Attack. Deals more damage to statused foes.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DEGOLCREST => {
	:ID => 1284,
	:name => "D. Golem Crest",
	:desc => "Recharging moves no longer require a turn to recharge. Normal-type moves become Psychic-type.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DECRUSCREST => {
	:ID => 1285,
	:name => "D. Crustle (B) Crest",
	:desc => "If Singles, doubles the effects from berries. If Doubles, shares held or flung berry effects with its partner.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:DEDUNCREST => {
	:ID => 1286,
	:name => "D. Dudunsparce Crest",
	:desc => "All multi-hit moves use the Attack stat and target the opponent's lower defense stat.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:WALKIETALKIE => {
	:ID => 1292,
	:name => "Walkie-Talkie",
	:desc => "A simple walkie-talkie used for communication at mid-long ranges.",
	:price => 0,
	:keyitem => true,
	:noUseInBattle => true,
	:noUse => true,
...
:QUARTZTEAR => {
	:ID => 1293,
	:name => "Quartz Tear",
	:desc => "An item to be held by a Pokémon. It is a gleaming tear-shaped crystal that ups the power of Crystal-type moves.",
	:price => 100,
	:noUseInBattle => true,
	:noUse => true,
	:typeboost => :CRYSTAL,
...
:TRANSPARENTPLATE => {
	...
	:desc => "An item to be held by a Pokémon. It is a stone tablet that boosts the power of Crystal-type moves.",
	:price => 999,
	:noUseInBattle => true,
	:noUse => true,
	:typeboost => :CRYSTAL,
...
:CRYSTALGEM => {
	:ID => 1295,
	:name => "Crystal Gem",
	:desc => "A gem with a mystical essence. When held, it strengthens the power of a Crystal-type move only once.",
	:price => 200,
	:noUseInBattle => true,
	:noUse => true,
	:typeboost => :CRYSTAL,
