...
:BLIZZARD => {
	...
	:target => :AllOpposing,
	:windmove => true,
	:desc => "A howling blizzard is blasted at the opposing team. It may cause frostbite."
},
...
:ICEBEAM => {
	...
	:target => :SingleNonUser,
	:beammove => true,
	:desc => "The target is struck with an icy-cold beam of energy. It may also cause frostbite."
},
...
:ICEFANG => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user bites with freezing fangs. It may flinch or cause frostbite."
},
...
:POWDERSNOW => {
	...
	:effect => 10,
	:target => :AllOpposing,
	:desc => "The user attacks with a chilling snow. It may also cause frostbite."
},
...
:HAIL => {
	...
	:target => :UserSide,
	:nonmirror => true,
	:desc => "A " + HAILSNOWLOWMOD + " storm lasting 5 turns damages all non-Ice type Pokémon."
},
...
:ELECTRIFY => {
	...
	:maxpp => 20,
	:target => :SingleNonUser,
	:desc => "Electrifies the target and makes its move become Electric-type on that turn."
},
...
:SHADOWCHILL => {
	...
	:target => :SingleNonUser,
	:nonmirror => true,
	:desc => "A shadowy ice attack that may cause frostbite."
},
...
:AURORAVEIL => {
	...
	:snatchable => true,
	:nonmirror => true,
	:desc => "Reduces damage from physical and special moves for five turns. Can be used only in a " + HAILSNOWLOWMOD + "storm."
},
...
### Partner Pikachu/Eevee Mod Moves ###
...
:PIKAPAPOW => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The more Pikachu loves its Trainer, the greater the move's power. It never misses."
},
...
:VEEVEEVOLLEY => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "The more Eevee loves its Trainer, the greater the move's power. It never misses."
},
...
:ZIPPYZAP => {
	...
	:priority => 2,
	:contact => true,
	:desc => "The user attacks the target with bursts of electricity at high speed. This move always goes first and results in a critical hit."
...
:FLOATYFALL => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user floats in the air, and then dives at a steep angle to attack the target. This may also make the target flinch."
},
...
:SPLISHYSPLASH => {
	...
	:effect => 30,
	:target => :AllOpposing,
	:desc => "The user charges a huge wave with electricity and hits the opposing Pokémon with the wave. This may also leave the opposing Pokémon with paralysis."
},
...
:BOUNCYBUBBLE => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user attacks by shooting water bubbles at the target. It then absorbs water and restores its HP by half the damage taken by the target."
},
...
:BUZZYBUZZ => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user shoots a jolt of electricity to attack the target. This also leaves the target with paralysis."
},
...
:SIZZLYSLIDE => {
	...
	:effect => 100,
	:target => :SingleNonUser,
	:desc => "The user cloaks itself in fire and charges at the target. This also leaves the target with a burn."
},
...
:BADDYBAD => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user acts bad and attacks the target. A wondrous wall of light is put up to weaken the power of the opposing Pokémon's physical moves."
},
...
:SAPPYSEED => {
	...
	:target => :SingleNonUser,
	:magiccoat => true,
	:desc => "The user grows a gigantic stalk that scatters seeds to attack the target. The seeds drain the target's HP every turn."
},
...
:FREEZYFROST => {
	...
	:target => :SingleNonUser,
	:kingrock => true,
	:desc => "The user attacks with a crystal made of cold frozen haze. It eliminates every stat change among all the Pokémon engaged in battle."
},
...
:BURNINGBULWARK => {
	...
	:priority => 4,
	:nonmirror => true,
	:desc => "User protects itself from attacks. Contact burns the target."
},
...
:CHILLYRECEPTION => {
	...
	:target => :UserSide,
	:nonmirror => true,
	:desc => "The user tells a chillingly bad joke and switches out. This summons a " + HAILSNOWLOWMOD + "storm lasting five turns."
},
...
:COLLISIONCOURSE => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user transforms and crashes to the ground, causing a massive prehistoric explosion. Stronger if super-effective."
},
...
:DOODLE => {
	...
	:target => :SingleOpposing,
	:nonmirror => true,
	:desc => "The user captures the very essence of the target in a sketch. User and ally copy target's ability."
},
...
:DRAGONCHEER => {
	...
	:target => :Partner,
	:nonmirror => true,
	:desc => "Encourages ally Pokémon, boosting their Critical Strike chance. More effective if the ally is Dragon type."
},
...
:ELECTRODRIFT => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user races forward at ultrafast speeds, piercing its target with futuristic electricity. Stronger if super-effective."
},
...
:ELECTROSHOT => {
	...
	:maxpp => 10,
	:target => :SingleNonUser,
	:desc => "First turn boost Sp.Atk, second turn attack the target. No charge during rain."
},
...
:FICKLEBEAM => {
	...
	:maxpp => 5,
	:target => :SingleNonUser,
	:desc => "Deals damage that has a 30% chance to double in power."
},
...
:HYPERDRILL => {
	...
	:bypassprotect => true,
	:contact => true,
	:desc => "The user spins the pointed part of its body at high speed to pierce the target, ignoring protecting moves."
},
...
:IVYCUDGEL => {
	...
	:maxpp => 10,
	:target => :SingleNonUser,
	:desc => "Strike with an ivy-wrapped cudgel, type depends on the user's mask."
},
...
:MALIGNANTCHAIN => {
	...
	:effect => 50,
	:target => :SingleNonUser,
	:desc => "The user pours toxins into the target with chains. May leave the target badly poisoned."
},
...
:MIGHTYCLEAVE => {
	...
	:bypassprotect => true,
	:sharpmove => true,
	:desc => "Cleaves the target. Ignores protecting moves."
},
...
:ORDERUP => {
	...
	:target => :SingleNonUser,
	:contact => false,
	:desc => "The user attacks with elegant poise. If the user has a Tatsugiri in its mouth, boosts user's stats based on its form."
},
...
:PSYCHICNOISE => {
	...
	:target => :SingleNonUser,
	:soundmove => true,
	:desc => "Damages the target and prevents it from healing for two turns."
},
...
:RAGINGBULL => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user performs a tackle like a raging bull. Type depends on form. Can also break barriers."
},
...
:SHEDTAIL => {
	...
	:target => :User,
	:nonmirror => true,
	:desc => "The user creates a substitute for itself using its own HP before switching places with a party Pokémon in waiting."
},
...
:SUPERCELLSLAM => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "The user slams down on the target. If it misses, the user is hurt instead."
},
...
:TACHYONCUTTER => {
	...
	:target => :SingleNonUser,
	:sharpmove => true,
	:desc => "The user launches particle blades at the target twice. This attack never misses."
},
...
:TEMPERFLARE => {
	...
	:target => :SingleNonUser,
	:contact => true,
	:desc => "Spurred by desperation, the user attacks. If the user's previous move failed, the power of this move doubles."
},
...
:TERASTARSTORM => {
	...
	:maxpp => 5,
	:target => :SingleNonUser,
	:desc => "Attacks the target with crystals. Hits all opposing Pokémon in Stellar Form."
},
...
:THUNDERCLAP => {
	...
	:target => :SingleNonUser,
	:priority => 1,
	:desc => "User attacks first. It fails if the target is not readying a damaging move."
},
...
:UPPERHAND => {
	...
	:priority => 3,
	:contact => true,
	:desc => "Only works when target uses priority move. Flinches the target."
},
...
# GEN 9 MOD MOVE DUMMIES FOR ANIMATION COMPILATION, PLEASE DEFINE REAL GEN 9 MOVES ABOVE HERE

:IVYCUDGELWATER => {
	:name => "Ivy Cudgel ANIMATION",
	:function => 0x910,
	:type => :WATER,
	:category => :physical,
	:basedamage => 100,
...
:ORDERUPCURLY => {
	...
	:maxpp => 10,
	:target => :SingleNonUser,
	:desc => "Attack with elegant poise. If Tatsugiri is in its mouth, boosts a specific stat."
},
...
:SUBZEROSLAMMER => {
	...
	:target => :SingleNonUser,
	:zmove => true,
	:desc => "The user dramatically drops the temperature using its Z-Power and causes frostbite with full force. The power varies, depending on the original move."
},
...
:CRYSTALRUSH => {
	...
	:priority => 1,
	:contact => true,
	:desc => "The user turns to solid crystal, hitting first."
},
...
:LIVEWIRE => {
	...
	:magiccoat => true,
	:nonmirror => true,
	:desc => "Causes Pokemon that are switched in to be immediately Paralyzed."
},
...
:MEDUSARAY => {
	...
	:target => :SingleNonUser,
	:magiccoat => true,
	:desc => "The user shoots a terrifying glare right at the opponent, leaving them petrified."
},
...
:MORPH => {
	...
	:target => :SingleNonUser,
	:nonmirror => true,
	:desc => "If a Delta version of the opponent exists, the user morphs into that. Otherwise, Transforms."
},
...
:PERMAFROST => {
	...
	:magiccoat => true,
	:nonmirror => true,
	:desc => "Frost covers the ground around the foe, randomly freezing foes who switch in."
},
...
:WILDFIRE => {
	...
	:magiccoat => true,
	:nonmirror => true,
	:desc => "Burns the foe. If it is a Grass-type, burns all in their party that are very weak to fire."
},
...
:SPIRITAWAY => {
	...
	:contact => true,
	:kingrock => true,
	:desc => "The target is whisked away, returning on the next turn. The target cannot attack during this time."
},
