...
:SNOWCLOAK => {
	:ID => 81,
	:name => "Snow Cloak",
	:desc => "Raises evasion in a " + HAILSNOWLOWMOD + "storm."
},
...
:ICEBODY => {
	:ID => 115,
	:name => "Ice Body",
	:desc => "The Pokémon gradually regains HP in " + HAILSNOWLOWMOD + "."
},
...
:SNOWWARNING => {
	:ID => 117,
	:name => "Snow Warning",
	:desc => "The Pokémon summons a " + HAILSNOWLOWMOD + "storm in battle."
},
...
:SLUSHRUSH => {
	:ID => 216,
	:name => "Slush Rush",
	:desc => "Doubles the Pokémon's Speed stat in a " + HAILSNOWLOWMOD + "storm."
},
...
:ICEFACE => {
	...
	:fullDesc => "Can take a physical attack once. This effect is restored once when it " + HAILSNOWLOWMOD + "s."
},
...
:LUNARIDOL => {
	...
	:fullDesc => "Ice-type moves deal 50% more damage, special attack is boosted by 50% in " + HAILSNOWLOWMOD + ", and is immune to Ground-type moves."
},
...
:ARMORTAIL => {
	...
	:fullDesc => "The mysterious tail covering the Pokémon's head makes opponents unable to use priority moves against the Pokémon or its allies."
},
...
:COSTAR => {
	:ID => 318,
	:name => "Costar",
	:desc => "Copies an ally's stat changes...",
...
:MYCELIUMMIGHT => {
	:ID => 326,
	:name => "Mycelium Might",
	:desc => "Status moves are unimpeded but slower...",
	:fullDesc => "The Pokémon will always act more slowly when using status moves, but these moves will be unimpeded by the Ability of the target."
},
...
:ORICHALCUMPULSE => {
	...
	:desc => "Summons harsh sunlight while boosting Attack...",
...
:WINDPOWER => {
	:ID => 342,
	:name => "Wind Power",
	:desc => "Pokémon becomes charged from taking wind damage...",
...
:WINDRIDER => {
	:ID => 343,
	:name => "Wind Rider",
	:desc => "Boosts Attack in Tailwind or by wind moves...",
...
:TOXICCHAIN => {
	...
	:fullDesc => "The power of the Pokémon's toxic chain may badly poison any target the Pokémon hits with a move."
},

:MINDSEYE => {
	:ID => 348,
	:name => "Mind's Eye",
	:desc => "Ignores evasion, accuracy loss, & Ghost immunities...",
	:fullDesc => "Ignores changes to opponents' evasiveness, its accuracy can't be lowered, and it can hit Ghost types with Normal- and Fighting-type moves."
},
...
:PSYCHOCALL => {
	:ID => 401,
	:name => "Psycho Call",
	:desc => "Powers up Psychic-type moves in a pinch...",
	:fullDesc => "Increases Attack/Special Attack by 50% when below 1/3 max HP when using Psychic-type moves."
},

:SPIRITCALL => {
	:ID => 402,
	:name => "Spirit Call",
	:desc => "Powers up Ghost-type moves in a pinch...",
	:fullDesc => "Increases Attack/Special Attack by 50% when below 1/3 max HP when using Ghost-type moves."
},

:SHADOWCALL => {
	:ID => 403,
	:name => "Shadow Call",
	:desc => "Powers up Dark-type moves in a pinch...",
	:fullDesc => "Increases Attack/Special Attack by 50% when below 1/3 max HP when using Dark-type moves."
},

:HUBRIS => {
	:ID => 404,
	:name => "Hubris",
	:desc => "Boosts Sp. Atk after knocking out any Pokémon."
},

:NOCTEM => {
	:ID => 405,
	:name => "Noctem",
	:desc => "The Pokémon summons shadowy skies in battle.",
},

:SHADOWDANCE => {
	:ID => 406,
	:name => "Shadow Dance",
	:desc => "Doubles the Pokémon's Speed stat in shadow sky."
},

:HELIOPHOBIA => {
	:ID => 407,
	:name => "Heliophobia",
	:desc => "The Pokémon gradually regains HP in shadow sky."
},

:ABSOLUTION => {
	:ID => 408,
	:name => "Absolution",
	:desc => "Shadowy skies boost Sp. Atk but HP decreases...",
	:fullDesc => "Under Shadow Sky, Special Attack is boosted by 50%, but HP decreases by 1/8th max HP per turn."
},

:BLAZEBOOST => {
	:ID => 409,
	:name => "Blaze Boost",
	:desc => "Fire moves boosts stats and may burn on contact...",
	:fullDesc => "Damaging Fire-type moves changes form and raises the user's Attack, Sp. Attack and Speed one stage, once per battle. Form may burn on contact."
},

:WINDFORCE => {
	:ID => 410,
	:name => "Wind Force",
	:desc => "Raises Speed if hit by an Flying-type move."
},

:CHLOROFURY => {
	:ID => 411,
	:name => "Chlorofury",
	:desc => "Boosts itself to avenge fallen allies...",
	:fullDesc => "Upon entering battle, its Speed and Sp. Atk stats are boosted for 2 turns by 1 stage for each ally in its party that's been defeated."
},

:REGURGITATION => {
	:ID => 412,
	:name => "Regurgitation",
	:desc => "The Pokémon's minion does follow up damage...",
	:fullDesc => "Additional damage done to 1/6 of target's max HP for every successful attack or targetable status move. Damage typing based on form."
},

:SUPERCELL => {
	:ID => 413,
	:name => "Supercell",
	:desc => "Sp. Atk surges in the Rain and Darkness...",
	:fullDesc => "Under Shadow Sky and Rain, Special Attack is boosted by 50%. If the Pokémon is Typhlosion, its form changes as well."
},

:AMPLIFIER => {
	:ID => 414,
	:name => "Amplifier",
	:desc => "Sound moves are boosted and wakes everyone up...",
	:fullDesc => "Sound-based moves are boosted by 1.25x. Also, sound-based moves will now wake up all sleeping Pokémon on the field."
},
...
:VAMPIRIC => {
	:ID => 416,
	:name => "Vampiric",
	:desc => "Recovers a little HP with contact moves.",
},
...
:PRISMGUARD => {
	:ID => 418,
	:name => "Prism Guard",
	:desc => "Inflicts damage to the Pokémon on non-contact...",
	:fullDesc => "Inflicts damage to the Pokémon when hit by non-contact moves equal to 1/8th of its max HP."
},

:WINDBORNETYRANT => {
	:ID => 419,
	:name => "Windborne Tyrant",
	:desc => "Immune to Flying moves and summons Tailwind...",
	:fullDesc => "The Pokémon is immune to all Flying-type moves. It will also summon Tailwind for 2 turns upon entry."
},

:PROTOABSOLUTION => {
	:ID => 420,
	:name => "Protoabsolution",
	:desc => "Boosts its best stat under shadowy skies...",
	:fullDesc => "Raises the Pokémon's highest stat while under shadow sky by 30% (50% if highest stat is speed). Can also be activated with Booster Energy."
},

:OPPRESSIVECOLD => {
	:ID => 421,
	:name => "Oppressive Cold",
	:desc => "Reverses Fire and Ice-type interactions...",
	:fullDesc => "Fire-type moves are not very effective against this Pokémon. Ice-type moves used by this Pokémon are Super Effective against Fire types."
},

:REVERSALBARRIER => {
	:ID => 422,
	:name => "Refraction",
	:desc => "Resistances and Weaknesses are swapped...",
	:fullDesc => "The Pokémon's defensive type chart is flipped, causing its weaknesses to be resistances and resistances to be weaknesses."
},
...
:SLAG => {
	:ID => 424,
	:name => "Slag",
	:desc => "Inflicts fire damage to the Pokémon on contact...",
	:fullDesc => "Inflicts fire-type damage to the Pokémon on contact equal to 1/8th of its max HP."
},

:PROTOCRYOPHILIC => {
	:ID => 425,
	:name => "Protocryophilic",
	:desc => "Boosts its best stat under the hail...",
	:fullDesc => "Raises the Pokémon's highest stat while under hail by 30% (50% if highest stat is speed). Can also be activated with Booster Energy."
},

:SPEEDSWAP => {
	:ID => 426,
	:name => "Speed Swap",
	:desc => "Activates Trick Room on entry...",
	:fullDesc => "The Pokémon activates Trick Room for 2 turns upon entering battle."
},

:SLEET => {
	:ID => 427,
	:name => "Sleet",
	:desc => "Summons Hail and increases its damage...",
	:fullDesc => "The Pokémon summons a hailstorm in battle and increases its end-of-turn damage to 1/5th of max HP."
},
...
:PROTEANMAXIMA => {
	:ID => 429,
	:name => "Protean Maxima",
	:desc => "The Pokémon changes form based on move...",
	:fullDesc => "The Pokémon changes form, stats and ability corresponding with its evolutions based on the type of move it uses."
},

:UNLEAFED => {
	:ID => 430,
	:name => "Unleafed",
	:desc => "Boosts stats to avenge fallen allies...",
	:fullDesc => "Upon entering battle, all stats are increased by 1 stage and lasts for each of the allies in its party that have already been defeated."
},

:SPECTRALJAWS => {
	:ID => 431,
	:name => "Spectral Jaws",
	:desc => "All Biting moves are Special and boosted...",
	:fullDesc => "All Biting moves become Special Attacks and the power of biting moves is increased by 50%."
},

:IRRELEPHANT => {
	:ID => 432,
	:name => "Irrelephant",
	:desc => "Immunities are irrelephant to this Pokémon...",
	:fullDesc => "This Pokémon ignores all type-based immunities."
},

:PENDULUM => {
	:ID => 433,
	:name => "Pendulum",
	:desc => "Increases power of moves used consecutively...",
	:fullDesc => "Each time a move is used consecutively, its power is boosted by 20% up to a maximum increase of 100%."
},
...
:LERNEAN => {
	:ID => 435,
	:name => "Lernean",
	:desc => "Grows more heads when it loses HP...",
	:fullDesc => "This Pokémon gains more heads if their HP decreases below 80%, 60%, 40%, or 20%, splitting attack power across each head."
},

:PERIODICORBIT => {
	:ID => 436,
	:name => "Periodic Orbit",
	:desc => "Delayed moves will orbit and activate twice.",
},

:ANCIENTPRESENCE => {
	:ID => 437,
	:name => "Ancient Presence",
	:desc => "User's moves are user's type and become neutral...",
	:fullDesc => "User has STAB with all moves and all damaging moves used will deal neutral damage except for items or abilities granting type-immunity."
},

:OMNITYPE => {
	:ID => 438,
	:name => "Omnitype",
	:desc => "Defending, the user is considered every type...",
	:fullDesc => "All moves used against the target will factor in the weaknesses, resistances, and immunities of every type at once."
},

:SHADOWSYNERGY => {
	:ID => 439,
	:name => "Shadow Synergy",
	:desc => "Summons a dark power to boost Dark-type moves...",
	:fullDesc => "Increases its respective stat by 50% when a Dark-type move is used."
},

:WINTERJOY => {
	:ID => 440,
	:name => "Winter Joy",
	:desc => "Strengthened in hail and weakened under harsh sun...",
	:fullDesc => "In hail, Atk and SpAtk is boosted by 40%. In harsh sunlight, Atk and SpAtk is decreased by 30%."
},

:CEREBRALFIST => {
	:ID => 441,
	:name => "Cerebral Fist",
	:desc => "All punching moves become Psychic-type moves."
},

:SUBLIMATINGEDGE => {
	:ID => 442,
	:name => "Sublimating Edge",
	:desc => "User swaps type and buffs slicing moves...",
	:fullDesc => "User swaps between Electric and Ice-type. Normal-type moves are based on user's type and slicing moves have a higher critical-hit ratio."
},
