    ...
    :BOSSCHESNAUGHT_1 => {
        ...
        :onBreakEffects => {
            1 => {
                ...
                :animation => :SEEDFLARE,
                :fieldChange => :FOREST,
                :message => "The statue called for the trees!",
    ...
    :BOSSDELPHOX_1 => {
        ...
        :onBreakEffects => {
            1 => {
                ...
                :animation => :OVERHEAT,
                :fieldChange => :INFERNAL,
                :message => "The statue scorched the souls in the area!",
                :itemchange => :ELEMENTALSEED,
    ...
    :BOSSGRENINJA_1 => {
        ...
        :onBreakEffects => {
            1 => {
                ...
                :animation => :SURF,
                :fieldChange => :WATERSURFACE,
                :message => "The statue summoned the tides to carry the battle to the surface!",
