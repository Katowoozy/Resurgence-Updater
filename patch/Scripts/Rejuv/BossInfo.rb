...
##############################
    ...
    :SEAPRINCE => {
        ...
        :onBreakEffects => { # in order of shield count, with the highest value being the first shield broken and the lowest the last
            ...
            1 => {
                ...
                :movesetUpdate => [:WATERPULSE,:SHADOWBALL,:WHIRLPOOL,:TAKEHEART],
                :abilitychange => :SWIFTSWIM,
    ...
    :BOSSGOTHITELLE => {
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :formchange => 3,
                :message => "CRESCENT: You probably think I'm desperate, right? Well I'll SHOW you desperate!",
                :abilitychange => :ETHEREALSHROUD,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            }
    ...
    :DUFAUX => {
        ...
        :onBreakEffects => {
            ...
            2 => {
                ...
                :formchange => 3,
                :weatherChange => :HAIL,
                :weatherChangeMessage => HAILSNOWMOD + " started to fall!",
                :weatherChangeAnimation => "Hail",
                :playerSideStatChanges => {
                    PBStats::ATTACK => -1,
                    PBStats::DEFENSE => -1,
    ...
    :IRONHELL => {
        ...
        :moninfo => {
            ...
            :level => 100,
            :item => :AIRBALLOON,
            :moves => [:MOONLIGHT,:HYPERSPACEHOLE,:MYSTICALFIRE,:LUNARCANNON],
            :ability => :QUARKDRIVE,
            :nature => :MODEST,
            :form => 1,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                ...
                :itemchange => :ELECTRICGEM,
                :fieldChange => :ELECTERRAIN, # field changes
                :movesetUpdate => [:OVERHEAT,:DARKPULSE,:HURRICANE,:THUNDERBOLT],
                :bossStatChanges => {
                    PBStats::DEFENSE => 2,
                    PBStats::SPATK => 1
                }
    ...
    :BOSSDELTAMUK => {
        :name => "Sarlacc",
        :entryText => "The sand is coarse and rough and irritating, and it's getting everywhere!",
        :shieldCount => 6,
        :immunities => {},
        :moninfo => {
            :species => :MUK,
            :level => 70,
            :form => 2,
            :moves => [:DIG,:SUBMISSION,:SUCKERPUNCH,:SHOREUP],
            :gender => "M",
            :ability => :SAPSIPPER,
            :nature => :BRAVE,
            :item => :SOFTSAND,
        ...
        :onBreakEffects => {
            6 => {
                ...
                :animation => :SWALLOW,
                :formchange => 3,
                :message => "The sand began spitting up its prey!",
                :abilitychange => :REGURGITATION,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
                :bossStatChanges => {
            ...
            5 => {
                ...
                :animation => :SWALLOW,
                :formchange => 4,
                :message => "The sand is spitting up new prey!",
                :abilitychange => :REGURGITATION,
                :bossEffect => :Ingrain,
                :bossEffectduration => true,
                :bossEffectanimation => :INGRAIN,
                :bossEffectMessage => "Roots sprouted from within the sand!",
                :statDropCure => true,
                :effectClear => true,
            },
            4 => {
                ...
                :weatherChange => :SUNNYDAY, 
                :weatherCount => 5, 
                :weatherChangeMessage => "Sunlight beamed through the cracks in the cavern ceiling!", 
                :weatherChangeAnimation => "Sunny", 
                :movesetUpdate => [:DIG,:SUBMISSION,:FIREPUNCH,:SHOREUP],
                :statDropCure => true,
                :effectClear => true,
            },
            3 => {
                ...
                :bossEffect => :Snatch,
                :bossEffectduration => true,
                :bossEffectanimation => :SNATCH,
                :bossEffectMessage => "The sand is awaiting your next move...",
                :movesetUpdate => [:DIG,:SUBMISSION,:SUCKERPUNCH,:SHOREUP],
            },
            2 => {
                :threshold => 0,
                :animation => :SWALLOW,
            ...
            1 => {
                ...
                :message => "The sand is spitting up new prey!",
                :abilitychange => :REGURGITATION,
                :bossEffect => :MagicCoat,
                :bossEffectduration => true, 
                :bossEffectanimation => :MAGICCOAT, 
                :bossEffectMessage => "{1} shrouded itself with Magic Coat!", 
                :statDropCure => true,
                :effectClear => true,
            },
        },
    ...
    :BOSSBANETTE => {
        :name => "Banette",
        :entryText => "The statue came to life and attacked!",
        :shieldCount => 1,
        :immunities => {},
        :moninfo => {
            :species => :BANETTE,
            :level => 80,
            :moves => [:PHANTOMFORCE,:SHADOWSNEAK,:WILLOWISP,:KNOCKOFF],
            :ability => :CURSEDBODY,
            :nature => :ADAMANT,
            :item => :LIFEORB,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :animation => :GROWL,
                :message => "Banette is snickering at you!", 
                :abilitychange => :INSOMNIA,
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::ATTACK => 1,          
    ...
    :BOSSMIMIKYU => {
        ...
        :moninfo => {
            :species => :MIMIKYU,
            :level => 80,
            :moves => [:SWORDSDANCE,:SHADOWSNEAK,:PLAYROUGH,:SHADOWCLAW],
            :ability => :DISGUISE,
            :nature => :JOLLY,
            :item => :LIFEORB,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :formchange => 0,
                :message => "Mimikyu is fixing up its disguise!", 
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::SPEED => 1,          
    ...
    :BOSSSABLEYE => {
        ...
        :moninfo => {
            :species => :SABLEYE,
            :level => 80,
            :moves => [:NIGHTSHADE,:WILLOWISP,:TAUNT,:RECOVER],
            :ability => :PRANKSTER,
            :nature => :BOLD,
            :item => :MAGICALSEED,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :animation => :HONECLAWS,
                :message => "Sableye is sharpening itself!", 
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::DEFENSE => 1, 
    ...
    :BOSSTYPHLOSION => {
        ...
        :moninfo => {
            ...
            :level => 80,
            :form => 1,
            :moves => [:INFERNALPARADE,:FLAMETHROWER,:FOCUSBLAST,:INFERNO],
            :ability => :FRISK,
            :nature => :TIMID,
            :item => :LIFEORB,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :animation => :OVERHEAT,
                :message => "Typhlosion is heating up!", 
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::SPATK => 1,        
    ...
    :BOSSAEGISLASH => {
        ...
        :moninfo => {
            :species => :AEGISLASH,
            :level => 80,
            :moves => [:SHADOWBALL,:CLOSECOMBAT,:KINGSSHIELD,:SHADOWSNEAK],
        ...
        :onBreakEffects => {
            1 => {
                ...
                :message => "Aegislash is sharpening itself!", 
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::ATTACK => 1, 
    ...
    :BOSSSIGILYPH => {
        ...
        :moninfo => {
            ...
            :level => 80,
            :form => 1,
            :moves => [:SHADOWBALL,:MOONBLAST,:DREAMEATER,:HYPNOSIS],
            :ability => :TINTEDLENS,
            :nature => :TIMID,
            :item => :LIFEORB,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                ...
                :bossEffect => :LockOn,
                :bossEffectduration => 1,
                :bossEffectMessage => "{1} took aim!", 
                :bossEffectanimation => :MINDREADER,
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::SPATK => 1,        
    ...
    :BOSSMAROWAK => {
        ...
        :moninfo => {
            ...
            :level => 80,
            :form => 1,
            :moves => [:FLAREBLITZ,:SHADOWBONE,:EARTHQUAKE,:LOWKICK],
            :ability => :ROCKHEAD,
            :nature => :ADAMANT,
            :item => :THICKCLUB,
            :iv => 31,
        ...
        :onBreakEffects => {
            1 => {
                ...
                :message => "Marowak is heating up its bone!", 
                :statusCure => true,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::ATTACK => 1,      
    ...
    :BOSSAMBIPOM => {
        ...
        :moninfo => {
            ...
            :level => 80,
            :form => 1,
            :moves => [:SHADOWPUNCH,:FAKEOUT,:ACHILLESHEEL,:POWERUPPUNCH],
            :ability => :TECHNICIAN,
            :nature => :JOLLY,
            :item => :LIFEORB,
            :iv => 31,
        ...
        :sosDetails =>  { # pokemon details
            :activationRequirement => "@battle.battlers[battlerIndex].shieldCount == 0",
            :entryMessage => "Ambipom's Shadow Clone entered the fray!",
            :continuous => true,
            :totalMonCount => 2,
            :moninfos => {
                1 => {
        ...
        :onBreakEffects => {
            1 => {
                ...
                :message => "Ambipom used Kage Bunshin no Jutsu!", 
            },
        },
    },
    :LICHDRAGON => {
        :name => "Lichdragon",
        :entryText => "The soulflames gathered and flared the statue to life!",
        :shieldCount => 3,
        :immunities => {},
        :moninfo => {
            :species => :CHARIZARD,
            :level => 85,
            :form => 7,
            :moves => [:INFERNALPARADE,:FIRESPIN,:DRACOMETEOR,:AURASPHERE],
            :ability => :EXECUTION,
            :nature => :MODEST,
            :item => :WHITEHERB,
            :iv => 31,
        ...
        :onBreakEffects => {
            3 => {
                ...
                :animation => :DARKVOID,
                :playerSideStatusChanges => [:SLEEP,"Sleep"],
                :message => "The souls summoned the shadows to bring all those to rest...",
                :movesetUpdate => [:INFERNALPARADE,:BLUEFLARE,:LUNARCANNON,:MOONLIGHT],
                :typeChange => [:GHOST,:FIRE],
                :abilitychange => :DARKAURA,
                :itemchange => :MAGICALSEED,
                :weatherChange => :SHADOWSKY, 
                :weatherCount => 5, 
                :weatherChangeMessage => "Shadowy skies blanketed the room!", 
                :weatherChangeAnimation => "ShadowSky", 
                :bossStatChanges => {
                    PBStats::SPEED => 1,
                }
            },
            2 => {
                :threshold => 0,
                :animation => :ACIDDOWNPOUR,
                :movesetUpdate => [:VENOSHOCK,:BLUEFLARE,:DRACOMETEOR,:NASTYPLOT],
                :typeChange => [:POISON,:DRAGON],
                :abilitychange => :POISONHEAL,
                :itemchange => :DRAGONIUMZ,
                :fieldChange => :CORROSIVEMIST,
                :fieldChangeMessage => "The Lichdragon's skeleton corroded and filled the arena with toxic mist!",
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            },
            1 => {
                :threshold => 0,
                :movesetUpdate => [:VENOSHOCK,:MYSTICALFIRE,:VENOMDRENCH,:MOONLIGHT],
                :typeChange => [:POISON,:FIRE],
                :itemchange => :ELEMENTALSEED,
                :statDropCure => true,
                :bossStatChanges => {
                    PBStats::SPATK => 2,
    ...
    :BOSSCHESNAUGHT_1 => {
        ...
        :entryText => "The statue challenges you!",
        :shieldCount => 1,
        :immunities => {},
        :moninfo => {
            :species => :CHESNAUGHT,
            :level => 55,
            :form => 2,
            :moves => [:BODYPRESS,:KNOCKOFF,:SYNTHESIS,:GRASSYGLIDE],
            :ability => :GRASSPELT,
            :gender => nil,
            :nature => :IMPISH,
            :item => :LEFTOVERS,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :fieldChange => :FOREST,
                :fieldChangeAnimation => :SEEDFLARE,
                :fieldChangeMessage => "The statue called for the trees!",
                :itemchange => :TELLURICSEED,
                :movesetUpdate => [:HEADSMASH,:KNOCKOFF,:SYNTHESIS,:WOODHAMMER],
                :typeChange => [:GRASS,:ROCK],
                :abilitychange => :RECKLESS,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
                :bossEffect => :Ingrain,
    ...
    :BOSSCHESNAUGHT_2 => {
        :name => "Guardian Shell",
        :entryText => "The Guardian hardens its defenses!",
        :shieldCount => 2,
        :immunities => {},
        :moninfo => {
            :species => :CHESNAUGHT,
            :level => 90,
            :moves => [:BODYPRESS,:KNOCKOFF,:SYNTHESIS,:SPIKES],
            :ability => :BULLETPROOF,
            :gender => nil,
            :nature => :IMPISH,
            :item => :ROCKYHELMET,
        ...
        :onBreakEffects => {
            2 => {
                ...
                :formchange => 1,
                :fieldChange => :SWAMP,
                :fieldChangeAnimation => :MUDDYWATER,
                :fieldChangeMessage => "A river stream muddied out the battlefield!",
                :message => "CHESNAUGHT: I see that your strength is not to be underestimated. Then I shall fight at my best as well.",
                :itemchange => :GRASSIUMZ,
                :movesetUpdate => [:STRENGTHSAP,:ZENHEADBUTT,:GYROBALL,:WOODHAMMER],
                :typeChange => [:GRASS,:STEEL],
                :abilitychange => :BULLETPROOF,
                :statDropCure => true,
                :statusCure => true,
            },
            1 => {
                ...
                :fieldChangeAnimation => :PETALBLIZZARD,
                :fieldChangeMessage => "The Guardian summoned a blossom amongst the field!",
                :message => "CHESNAUGHT: Let us fight amongst the florescence.",
                :itemchange => :ELEMENTALSEED,
                :movesetUpdate => [:DRAINPUNCH,:HEAVYSLAM,:SYNTHESIS,:WOODHAMMER],
                :abilitychange => :FLOWERVEIL,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            },
    ...
    :BOSSDELPHOX_1 => {
        ...
        :moninfo => {
            ...
            :level => 70,
            :form => 3,
            :moves => [:MYSTICALFIRE,:PSYSHOCK,:HIDDENPOWERGRA,:DAZZLINGGLEAM],
            :ability => :MAGICIAN,
            :gender => nil,
            :nature => :TIMID,
            :item => :FAIRIUMZ,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :fieldChange => :INFERNAL,
                :fieldChangeAnimation => :OVERHEAT,
                :fieldChangeMessage => "The statue scorched the souls in the area!",
                :itemchange => :ELEMENTALSEED,
                :movesetUpdate => [:INFERNO,:DARKPULSE,:EARTHPOWER,:HIDDENPOWERGRA],
                :typeChange => [:FIRE,:DARK],
                :abilitychange => :FLASHFIRE,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
    ...
    :BOSSDELPHOX_2 => {
        :name => "Guardian Wand",
        :entryText => "The Guardian readies its spells!",
        :shieldCount => 2,
        :immunities => {},
        :moninfo => {
            :species => :DELPHOX,
            :level => 90,
            :moves => [:DAZZLINGGLEAM,:FLAMETHROWER,:PSYCHIC,:GRASSKNOT],
            :ability => :MAGICIAN,
            :gender => nil,
            :nature => :MODEST,
            :item => :COLBURBERRY,
        ...
        :onBreakEffects => {
            2 => {
                ...
                :fieldChangeAnimation => :INFERNOOVERDRIVE,
                :fieldChangeMessage => "The Guardian set the field ablaze into a dragon's den!",
                :message => "DELPHOX: Extraordinary. Allow me to demonstrate my prowess as well.",
                :itemchange => :FIRIUMZ,
                :movesetUpdate => [:MAGMADRIFT,:DARKPULSE,:EARTHPOWER,:HIDDENPOWERGRA],
                :abilitychange => :MAGICIAN,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            },
            1 => {
                :threshold => 0,
                :fieldChange => :RAINBOW,
                :fieldChangeAnimationCommmon => "Rain",
                :fieldChangeMessage => "The Guardian doused out the field and summoned a rainbow overhead!",
                :message => "DELPHOX: May this mosaic bless us.",
                :itemchange => :MAGICALSEED,
                :movesetUpdate => [:MYSTICALFIRE,:SOLARBEAM,:DAZZLINGGLEAM,:HYPERVOICE],
                :abilitychange => :SOULHEART,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            },
    ...
    :BOSSGRENINJA_1 => {
        ...
        :moninfo => {
            ...
            :level => 85,
            :form => 2,
            :moves => [:WATERPULSE,:MUDBARRAGE,:HIDDENPOWERELE,:ICEBEAM],
            :ability => :PROTEAN,
            :gender => nil,
            :nature => :HASTY,
            :item => :ELEMENTALSEED,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0,
                :fieldChange => :WATERSURFACE,
                :fieldChangeAnimation => :SURF,
                :fieldChangeMessage => "The statue summoned the tides to carry the battle to the surface!",
                :itemchange => :WATERIUMZ,
                :movesetUpdate => [:SURF,:ICEBEAM,:WAVECRASH,:THUNDERBOLT],
                :typeChange => [:WATER,:ELECTRIC],
                :abilitychange => :SWIFTSWIM,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
                :bossEffect => :AquaRing,
                :bossEffectduration => true,
                :bossEffectanimation => :AQUARING,
            },
        }
    },
    :BOSSGRENINJA_2 => {
        :name => "Guardian Blade",
        :entryText => "The Guardian sharpens its edge!",
        :shieldCount => 2,
        :immunities => {},
        :moninfo => {
            :species => :GRENINJA,
            :level => 90,
            :moves => [:HYDROPUMP,:ICEBEAM,:GRASSKNOT,:HIDDENPOWERFIR],
            :ability => :PROTEAN,
            :gender => nil,
            :nature => :HASTY,
            :item => :LIFEORB,
        ...
        :onBreakEffects => {
            2 => {
                :threshold => 0,
                :formchange => 1,
                :fieldChange => :MURKWATERSURFACE,
                :fieldChangeAnimation => :SLUDGEWAVE,
                :fieldChangeMessage => "A sludgy stream overtook the field!",
                :message => "GRENINJA: As expected. Now display your full aptitude to me.",
                :itemchange => :WATERIUMZ,
                :movesetUpdate => [:WATERSHURIKEN,:VENOSHOCK,:MUDBARRAGE,:VENOMDRENCH],
            ...
            1 => {
                :threshold => 0,
                :fieldChange => :UNDERWATER,
                :fieldChangeAnimationCommmon => "Spirit Away Charging",
                :fieldChangeMessage => "The Guardian dragged the battle into the sea floor!",
                :message => "GRENINJA: Show me how you handle in such disadvantageous depths.",
                :itemchange => :ELEMENTALSEED,
                :movesetUpdate => [:WATERSHURIKEN,:MUDBARRAGE,:SNARL,:FROSTBREATH],
                :typeChange => [:WATER,:DARK],
                :abilitychange => :TECHNICIAN,
                :statDropCure => true,
                :statusCure => true,
    ...
    :MEGASWARMMETAGROSS => {
        :name => "Mega Swarm Leader",
        :entryText => "The Swarm Leader emerged from the trees!",
        :shieldCount => 1,
        :immunities => {},
        :moninfo => {
            :species => :METAGROSS,
            :level => 87,
            :moves => [:FIRSTIMPRESSION,:DRILLRUN,:SMARTSTRIKE,:BARBEDWEB],
            :ability => :POISONTOUCH,
            :nature => :ADAMANT,
            :item => :SYNTHETICSEED,
			:shiny => true,
        ...
        :onBreakEffects => {
            1 => {
                :threshold => 0.5,
                :message => "The Swarm Leader has gotten desperate!",
                :itemchange => :SITRUSBERRY,
                :movesetUpdate => [:BARBEDWEB,:SMARTSTRIKE,:FACADE,:DRILLRUN],
                :typeChange => [:BUG,:STEEL],
                :abilitychange => :TOXICBOOST,
				:formchange => 5,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
		:bossStatusChangesOverride => [:POISON,"Poison"],
            },
        }
    },
##############################
...
:TEST2 => {
    ...
    :moninfo => {
        ...
        :level => 50,
        :item => :CRYOGONITE,
        :moves => [:AURORAVEIL,:FREEZEDRY,:RECOVER,:ANCIENTPOWER],
        :ability => :LEVITATE,
    },
    :onBreakEffects => {
        2 => {
