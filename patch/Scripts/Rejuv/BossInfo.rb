    ...
    :BOSSCHESNAUGHT_2 => {
        ...
        :onBreakEffects => {
            2 => {
                ...
                :movesetUpdate => [:EARTHQUAKE,:ZENHEADBUTT,:GYROBALL,:WOODHAMMER],
                :typeChange => [:GRASS,:STEEL],
    ...
    :BOSSGRENINJA_2 => {
        ...
        :onBreakEffects => {
            2 => {
                ...
                :itemchange => :WATERIUMZ,
                :movesetUpdate => [:WATERSHURIKEN,:VENOSHOCK,:MUDBARRAGE,:DARKPULSE],
            ...
            1 => {
                ...
                :itemchange => :ELEMENTALSEED,
                :movesetUpdate => [:WATERSHURIKEN,:MUDBARRAGE,:DARKPULSE,:ICEBEAM],
                :typeChange => [:WATER,:DARK],
                :abilitychange => :PROPELLERTAIL,
                :statDropCure => true,
                :statusCure => true,
                :effectClear => true,
            },
