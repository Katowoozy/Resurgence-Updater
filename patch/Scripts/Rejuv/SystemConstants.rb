GAMETITLE = "Pokemon Rejuvenation Resurgence"
GAMEFOLDER = "Rejuv"
SAVEFOLDER = "Rejuv"
Reborn = false
Desolation = false
Rejuv = true
Gen = 9
# Gen 9 Mod - Added System Constants for the Mod.
RejuvGen9Mod = true
GEN9MODFOLDER = "Rejuv Resurgence"
GEN9MODTYPE = "Base"
GEN9MODVERSION = "0.01"
GEN9MODVERSIONHAILSNOW = "0"
# Gen 9 Mod - These constants are required to allow the Hail/Snow integrated mod to work properly.
...
Decidueye = []
# Paldean
PWooper = [39,201,356,369,370,599,600,601,602]
CombatTauros = [352]
BlazeTauros = [351]
AquaTauros = [369]
# Aevian
...
BerryDwebble = [24]
CakeDwebble = []
Purrloin = [9,149,194,209]
DFeebas = [157]
Aipom = [102]
DGrimer = [373,510,511,512,513,514]
DWooper = [82]
Hoothoot = [128,303,435,436,437,438,440,443,470]
Dunsparce = [25,208,210,254,268,419]
Noibat = [111]
Sunkern = [64,119]
Scraggy = [211]
Heatmor = [111,415]
...
Snivy = [604]
Golett = [518]
DeltaParadoxes = [620,621,622,623]
Charmander = [219]
DGeodude = [4,12,77,109,133,159,161,162,184,474,488,489,508,628] 
DSnorunt = [140]
Combee = [55,474]
Girafarig = [201]
Scyther = [470]
...
Lotad = [624]
Yanma = [543]
Tangela = [207,373,510,515]
Croagunk = [629]
Munchlax = [258]
DYamask = [64]
Seedot = [59,238]
SummerDSnorlax = [76,196,373,381,422,476,510,511,512,513,514,515,516,517,518,519,520,523,524,527,531,533,535,536,537,539,541,542,560,573,574,575,576,577,578,579,580,591,603]
AutumnDSnorlax = [17,39,73,82,91,95,102,110,219,356,369,370,400,401,403,599,600,601,602]
WinterDSnorlax = [3,75,100,269,470,471,472,473,479,480,481,482,483,485,486,490,491,594,595,596,597,625]
SakuraDSnorlax = [133,199]
DBeldumS = [628,630]
