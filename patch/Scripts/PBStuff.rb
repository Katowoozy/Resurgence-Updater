...
class PBStuff
  ...
  TRACEABILITIES = [:PROTEAN,:CONTRARY,:INTIMIDATE, :WONDERGUARD,:MAGICGUARD,
    ...
    # Resurgence - Added Ice Cleats, Supercell, Winter Joy, Castle Moat, and Ethereal Shroud
    :ICECLEATS, :SUPERCELL, :WINTERJOY, :CASTLEMOAT, :ETHEREALSHROUD]
  ...
  ABILITYBLACKLIST = [
    ...
    # Resurgence - Added Protoabsolution, Protocryophilic
    :ZEROTOHERO,:COMMANDER,:QUARKDRIVE,:HADRONENGINE,:PROTOSYNTHESIS,:ORICHALCUMPULSE, :PROTOABSOLUTION, :PROTOCRYOPHILIC,
  ...
  FIXEDABILITIES = [
    ...
    :COMMANDER, :ASONECHILLING, :ASONEGRIM, :TERASHIFT, :PROTOABSOLUTION, :PROTOCRYOPHILIC]
...
###--------------------------------------PROTECTMOVE------------------------------------------------------------###
PROTECTMOVE = [:PROTECT, :DETECT,:KINGSSHIELD, :SPIKYSHIELD, :BANEFULBUNKER, :OBSTRUCT, :SILKTRAP, :BURNINGBULWARK,
  :FALLOUTSHELTER] # Gen 9 Mod - Added Silk Trap and Burning Bulwark / Resurgence - Added Fallout Shelter
...
###--------------------------------------TWOTURNAIRMOVE---------------------------------------------------------###
TWOTURNAIRMOVE = [:BOUNCE,:FLY, :SKYDROP , :SPIRITAWAY]
...
###--------------------------------------NEAR-UNIVERSAL-TMS-----------------------------------------------------###
UNIVERSALTMS = [:ACHILLESHEEL,:ATTRACT,:CAPTIVATE,:CONFIDE,:DOUBLETEAM,:ENDURE,:FACADE,:FRUSTRATION,:HIDDENPOWER,
...
STATUSCONDITIONMOVE = [:WILLOWISP, :DARKVOID,:GRASSWHISTLE, :HYPNOSIS,
  ...
  :STUNSPORE, :THUNDERWAVE, :SIZZLYSLIDE, :BUZZYBUZZ, :MORTALSPIN, :HYPOTHERMIA] # Gen 9 Mod - Added Mortal Spin
...
RATESHARERS = [:PROTECT, :DETECT,:QUICKGUARD, :WIDEGUARD, :ENDURE,
  ...
  :SILKTRAP, :BURNINGBULWARK, :FALLOUTSHELTER] # Gen 9 Mod - Added Silk Trap and Burning Bulwark / Resurgence - Added Fallout Shelter
...
NOCOPYMOVE = [:ASSIST,:COPYCAT, :MEFIRST, :METRONOME, :MIMIC, :MIRRORMOVE,
  ...
  :REVIVALBLESSING, :SILKTRAP, :BURNINGBULWARK, :FALLOUTSHELTER]
# Gen 9 Mod - Added Revival Blessing, Silk Trap and Burning Bulwark. Also Obstruct and Comeuppance. / Resurgence - Added Fallout Shelter
###--------------------------------------ZMOVES-----------------------------------------------------------------###
...
###--------------------------------------TWOTURNMOVE------------------------------------------------------------###
TWOTURNMOVE = [:BOUNCE,:DIG, :DIVE, :FLY, :PHANTOMFORCE,:SHADOWFORCE, :SKYDROP, :SPIRITAWAY]
...
PLATEITEMS = [:FISTPLATE,   :SKYPLATE,    :TOXICPLATE,  :EARTHPLATE,  :STONEPLATE,
  ...
  :PIXIEPLATE,  :DREADPLATE, :BLANKPLATE, :TRANSPARENTPLATE] # Gen 9 Mod - Added Blank Plate / Resurgence - Added Transparent Plate
...
FLINGDAMAGE=pbHashForwardizer({
  ...
  100 => [:ARMORFOSSIL,:CLAWFOSSIL,:COVERFOSSIL,:DOMEFOSSIL,:HARDSTONE,:HELIXFOSSIL,
   ...
   90 => [:DEEPSEATOOTH,:DRACOPLATE,:DREADPLATE,:EARTHPLATE,:FISTPLATE,:FLAMEPLATE,
          ...
          :BLANKPLATE,
          # Resurgence - Added Transparent Plate
          :TRANSPARENTPLATE],
   ...
   30 => [:ABILITYURGE,:ABSORBBULB,:AMULETCOIN,:ANTIDOTE,:AWAKENING,:BALMMUSHROOM,
          ...
          :ETHER,:EVERSTONE,:EXPSHARE,:FIRESTONE,:FLAMEORB,:FROSTORB,:FLOATSTONE,:FLUFFYTAIL,
  ...
  STATUSDAMAGE = pbHashForwardizer({
   ...
   5 => [:ALLYSWITCH,   :AROMATICMIST,    :CAMOUFLAGE, :CONVERSION,:ENDURE,:ENTRAINMENT,:FLOWERSHIELD,
         ...
         # Resurgence - Dragonify, Medusa Ray and Retrograde
         :DRAGONIFY,    :MEDUSARAY,       :RETROGRADE],
  ...
  15 => [:ASSIST,       :BATONPASS,       :DARKVOID, :FLORALHEALING,:GRASSWHISTLE,:HEALPULSE, :HEALINGWISH,:HYPNOSIS,:INGRAIN,
         ...
         # Gen 9 Mod - Added Chilly Reception. # Resurgence - Shadow Prayer
         :CHILLYRECEPTION,:SHADOWPRAYER],
  ...
  25 => [:ATTRACT,      :CONFUSERAY,      :DESTINYBOND, :DISABLE,:FOLLOWME, :LEECHSEED,
         ...
         :SUBSTITUTE,   :SWITCHEROO,      :TAUNT,:TOPSYTURVY, :TOXIC,:TRICK,:WILLOWISP, :HYPOTHERMIA, :CORROSIVEGAS, :OCTOLOCK],
  ...
  35 => [:AROMATHERAPY, :BANEFULBUNKER,   :HEALBELL,:KINGSSHIELD,:LIGHTSCREEN,:MATBLOCK,
         ...
         # Gen 9 Mod - Added Silk Trap and Burning Bulwark. / Resurgence - Added Fallout Shelter
         :BURNINGBULWARK, :SILKTRAP, :FALLOUTSHELTER],
  40 => [],
...
POKEMONTOMEGASTONE = {
  :CHARIZARD  => [:CHARIZARDITEX, :CHARIZARDITEY, :CHARIZARDITEG, :DELTACHARIZARDITEX, :DELTACHARIZARDITEY],
  :MEWTWO     => [:MEWTWONITEX, :MEWTWONITEY],
  :VENUSAUR   => [:VENUSAURITE, :VENUSAURITEG, :DELTAVENUSAURITE],
  :BLASTOISE  => [:BLASTOISINITE, :BLASTOISINITEG, :DELTABLASTOISINITE],
  :GENGAR     => [:GENGARITE, :GENGARITEG],
  :ABOMASNOW  => [:ABOMASITE],      :ABSOL      => [:ABSOLITE],
  :AERODACTYL => [:AERODACTYLITE],  :AGGRON     => [:AGGRONITE, :DELTAAGGRONITE],
  :ALAKAZAM   => [:ALAKAZITE],      :AMPHAROS   => [:AMPHAROSITE, :AEVIANAMPHAROSITE],
  :BANETTE    => [:BANETTITE],      :BLAZIKEN   => [:BLAZIKENITE],
  :GARCHOMP   => [:GARCHOMPITE],    :GYARADOS   => [:GYARADOSITE],
  :HERACROSS  => [:HERACRONITE],    :HOUNDOOM   => [:HOUNDOOMINITE],
  :KANGASKHAN => [:KANGASKHANITE],  :LUCARIO    => [:LUCARIONITE],
  :MANECTRIC  => [:MANECTITE],      :MAWILE     => [:MAWILITE],
  ...
  :GARDEVOIR  => [:GARDEVOIRITE, :DELTAGARDEVOIRITE],
  :GALLADE    => [:GALLADITE, :DELTAGALLADITE],
  :SCIZOR     => [:SCIZORITE, :DELTASCIZORITE],
  :GLALIE     => [:GLALITITE, :AEVIANGLALITITE, :DELTAGLALITITE],
  :PIDGEOT    => [:PIDGEOTITE, :DELTAPIDGEOTITE],
  :METAGROSS  => [:METAGROSSITE, :DELTAMETAGROSSITE1, :DELTAMETAGROSSITE2, :CRYSTALFRAGMENT],
  # Reborn thing
  :TANGROWTH  => [:PULSEHOLD],
  # Gmax Megas
  :BUTTERFREE => [:BUTTERFREENITE], :MACHAMP    => [:MACHAMPITE],
  :PIKACHU    => [:PIKACHUTITE],    :MEOWTH     => [:MEOWTHITE],
  :KINGLER    => [:KINGLERITE],     :LAPRAS     => [:LAPRASITE, :AEVIANLAPRASITE],
  :EEVEE      => [:EEVEETITE, :EEVITE],
  :SNORLAX    => [:SNORLAXITE],
  ...
  :SANDACONDA => [:SANDACONDITE],   :TOXTRICITY => [:TOXTRICITITE, :AEVIANTOXTRICITITE],
  ...
  :CINDERACE  => [:CINDERACITE],    :URSHIFU    => [:URSHIFITE],
  # Deso Megas
  :MIGHTYENA  => [:MIGHTYENITE],    :FERALIGATR  => [:FERALIGATRITE, :FERALIGATITE],
  ...
  # Resurgence Megas
  :BISHARP    => [:BISHARPITE, :DELTABISHARPITE],
  :SUNFLORA   => [:SUNFLORITE, :DELTASUNFLORITE],
  :FROSLASS   => [:FROSLASSITE, :DELTAFROSLASSITE],
  :POLIWRATH  => [:POLIWRATHITE],     :POLITOED    => [:POLITOEDITE],
  :MEGANIUM   => [:MEGANIUMITE],
  :SUDOWOODO  => [:SUDOWOODITE],      :MAROWAK     => [:MAROWITE],
  :DONPHAN    => [:DONPHANITE],       :MILTANK     => [:MILTANKITE],
  :TYPHLOSION => [:TYPHLOSIONITE, :DELTATYPHLOSIONITE],
  :GIRAFARIG  => [:GIRAFARIGITE, :DELTAGIRAFARIGITE],
  :MILOTIC    => [:MILOTITE, :DELTAMILOTITE],
  :SHIFTRY    => [:SHIFTRITE],        :FLYGON      => [:FLYGONITE],
  :CACTURNE   => [:CACTURNITE],       :JIRACHI     => [:JIRACHITE],
  :CHATOT     => [:CHATOTITE],        :SPIRITOMB   => [:SPIRITOMBITE],
  :ZEBSTRIKA  => [:ZEBSTRIKITE],      :ZOROARK     => [:ZORONITE],
  :GOTHITELLE => [:GOTHITITE],        :REUNICLUS   => [:REUNICLITE],
  :HAXORUS    => [:HAXORITE],         :CRYOGONAL   => [:CRYOGONITE],
  :STUNFISK   => [:STUNFISKITE],      :HYDREIGON   => [:HYDREIGONITE],
  :CRAWDAUNT   => [:CRAWDITE],
}
...
POKEMONTOCREST = {
  ...
  :FURRET => :FURRCREST,
  # Resurgence - Delta Crests (Noctowl and Luxray defined in hasCrest?)       
  :SCRAFTY => :DESCRACREST,           :AVALUGG => :DEAVACREST,
  :PLUSLE => :DEPLUSCREST,            :MINUN => :DEMINCREST,
  :GOLEM => :DEGOLCREST,              :CRUSTLE => :DECRUSCREST,
  :DUDUNSPARCE => :DEDUNCREST,
}
...
CORRECTMEGAFORM = {
  ...
  :CHARIZARDITEY          => [0],
  :CHARIZARDITEG          => [0],
  :DELTACHARIZARDITEX     => [4],
  :DELTACHARIZARDITEY     => [4],
  :BLASTOISINITE          => [0],
  :BLASTOISINITEG         => [0],
  :DELTABLASTOISINITE     => [3],
  :LAPRASITE              => [0],
  :AEVIANLAPRASITE        => [1],
  :AMPHAROSITE            => [0],
  :AEVIANAMPHAROSITE      => [1],
  ...
  :DELTAGLALITITE         => [4],
  :TOXTRICITITE           => [0,1],
  :AEVIANTOXTRICITITE     => [2],
  :PIDGEOTITE             => [0],
  :DELTAPIDGEOTITE        => [2],
  :METAGROSSITE           => [0],
  :DELTAMETAGROSSITE1     => [4],
  :DELTAMETAGROSSITE2     => [2],
  :CRYSTALFRAGMENT        => [2],
  :BISHARPITE             => [0],
  :DELTABISHARPITE        => [1],
  :FROSLASSITE            => [0],
