...
BerryProblem= {
    :ID => "100",
    :Name => "A Berry Big Problem",
    :Type => "Regular",
    :QuestDescription => "An Auditor seems berry curious about how the Berry Emporium has so many berries in stock. Apparently he didn't get berry far, so now it's up to me to get to the bottom of this berry big question.",
    :QuestGiver => "Auditor",
    :Stage1 => "Ask for a Starf Berry!",
    :Location1 => "Berry Emporium",
    :Stage2 => "Go back to the Auditor.",
    :Location2 => "Gearen Laboratory",
    :Stage3 => "Tail the Berry Clerk!",
    :Location3 => "Berry Emporium",
    :Stage4 => "Read the Report!",
    :Location4 => "Gearen Laboratory",
    :Stage5 => "Head back to Zumi!",
    :Location5 => "Magnolia Library",
    :Stage6 => "Find the Berry Clerk!",
    :Location6 => "Chastity/Venam's House",
    :Stage7 => "Find the Berry Clerk!",
    :Location7 => "Gearen Park",
    :RewardString => "???"
}
  SlightlyBonetrousled= {
  :ID => "100",
  :Name => "Slightly Bonetrousled",
  :Type => "Regular",
  :QuestDescription => "Seems like someone's lost their, uh, pile of bones? She claims it's a fossil, but people seem to disagree with her for some reason. Whatever, guess I'm back to doing dirty work, literally. Let's get their fossil back.",
  :QuestGiver => "Researcher",
  :Stage1 => "Find the fossil!",
  :Location1 => "Sand Stream Cave",
  :Stage2 =>  "Bring the fossil back!",
  :Location2 => "Sashila Village",
  :Stage3 =>  "Head to the ACDMC Center!",
  :Location3 => "Akuwa Town",
  :Stage4 =>  "Find the thief!",
  :Location4 => "Route 11",
  :Stage5 =>  "Bring the fossil back!",
  :Location5 => "Akuwa Town",
  :Stage6 =>  "Meet with the Researcher!",
  :Location6 => "Goldenwood Cave",
  :RewardString => "???"
}
BahHumbug = {
  :ID => "22",
  :Name => "Bah Humbug",
  :Type => "Regular",
  :QuestDescription => "Bart seems to have run into a Pokémon that's really bugged him. He can't quite figure out what it is, though. Whelp, time to investigate ourselves!",
  :QuestGiver => "Bart",
  :Stage1 => "Follow Bart.",
  :Location1 => "Goldenwood Forest",
  :RewardString => "???"
...
TaurosOut = {
  :ID => "100",
  :Name => "Who let the Tauros out!?",
  :Type => "Regular",
  :QuestDescription => "Looks like some Paldean Tauros managed to stampede out from Yui's Ranch. How udderly fantastic. I better find them before they bull-doze the route.",
  :QuestGiver => "Rancher",
  :Stage1 => "Find the Tauros!",
  :Location1 => "Route 7",
  :RewardString => "???"
}
